      ...
      <div className="relative mx-auto grid max-w-content items-center gap-12 lg:grid-cols-2 lg:gap-16">
        ...
        <div>
          <div className="relative">
            <div className="aspect-[2/3] overflow-hidden rounded-sm border border-olive-800 bg-olive-900 shadow-2xl shadow-black/40">
              {hero.imageSrc ? (
                <img
                  src={hero.imageSrc}
                  alt={hero.imageAlt}
                ...
                <div className="flex h-full flex-col items-center justify-center bg-gradient-to-br from-olive-900 via-olive-800 to-olive-950 p-8 text-center">
            ...
            <div className="absolute -bottom-4 -left-4 hidden h-24 w-24 border border-gold-400/20 md:block" />
            <div className="absolute -right-4 -top-4 hidden h-16 w-16 bg-gold-400/10 md:block" />
          </div>
        </div>
      </div>
    </section>
